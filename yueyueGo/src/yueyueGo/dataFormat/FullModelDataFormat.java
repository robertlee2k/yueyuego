...
public class FullModelDataFormat extends ArffFormat {
	...
	//父类中不包括的两个常量定义
	public   String FULL_MODEL_ARFF_PREFIX="all20052016-ext";//"AllTransaction20052016-ext";
//	protected static final String FULL_MODEL_LONG_ARFF_FILE = FULL_MODEL_ARFF_PREFIX+"-new.arff"; // 包含计算字段的ARFF格式，这是提供给各输入属性独立的分类器使用的，如分类树---20170106取消
	public   String FULL_MODEL_SHORT_ARFF_FILE = FULL_MODEL_ARFF_PREFIX+"-short.arff";// 不包含计算字段的ARFF格式，这是提供给各输入属性独立的分类器使用的，如神经网络
	
//	protected final static String FULL_MODEL_AVG_LINE = "chicang_days"; // 输入输出文件中的“持仓天数”名称
	
	//全模型用的训练字段 
	public  final String[] FULL_MODEL_ATTRIB_FORMAT_NEW={
...
//		"ishgtb",
	...
	//每次新扩展ARFF格式的校验位
	public  final String[] FULL_MODEL_EXT_ARFF_CRC= {
		ID,TRADE_DATE,CODE,SELL_DATE,DATA_DATE,"bias5_preday_dif","zhishu_code"
	};
	//每次新扩展ARFF格式增加的数据
	public  final String[] FULL_MODEL_EXT_ARFF_COLUMNS= {
	};
	
	//每次新的扩展ARFF文件整体格式
	public  final String[] FULL_MODEL_EXT_ARFF_FILE_FORMAT= FormatUtility.concatStrings(FULL_MODEL_EXT_ARFF_CRC,FULL_MODEL_EXT_ARFF_COLUMNS);
	...
	private  final String[] FULL_MODEL_DATA_LEFT = FormatUtility.concatStrings(new String[]{ID},FULL_MODEL_DATA_NOT_SAVED_IN_ARFF);
	public  final String[] FULL_MODEL_DATA_FORMAT_NEW=FormatUtility.concatStrings(FULL_MODEL_DATA_LEFT,FULL_MODEL_ATTRIB_FORMAT_NEW);
	...
	public String[] DAILY_DATA_TO_PREDICT_FULL_MODEL = FormatUtility.concatStrings(new String[]{ID},FULL_MODEL_ATTRIB_FORMAT_NEW,new String[]{CODE});
		

	// 此方法从All Transaction Data中保留计算收益率的相关字段，以及最后的收益率，删除其他计算字段
	public static GeneralInstances getTransLeftPartForFullModel(GeneralInstances allData)
			throws Exception {
	...
	public static GeneralInstances prepareTransDataForFullModel(GeneralInstances allData)
			throws Exception {
