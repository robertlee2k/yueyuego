...
public class ShouyilvDescribe {
	...
	public ShouyilvDescribe(String period, String policy, int count,  double shouyilvAverage,int positiveCount,
...
//		"所属区间,均线分组,总数,收益率平均值,正收益数,正收益率平均值,负收益数,负收益率平均值,正值率\r\n";
