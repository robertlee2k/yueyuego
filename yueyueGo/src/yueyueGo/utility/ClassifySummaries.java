...
public class ClassifySummaries {
	...
	public static final String SUMMARY_HEADER="时间段,均线策略,整体正收益股数,整体股数,整体TPR,选股比率,所选正收益股数,所选总股数,所选股TPR,提升率,所选股平均收益率,整体平均收益率,收益率差,是否改善,正向模型时间,正向阈值,阈值百分比,阈值使用缺省值,反向模型时间,反向阀值,反向阀值百分比,正向AUC[TOP],正向AUC[ALL]";
	//统计信息
