...
public class EvaluationConfDefinition implements Serializable{
	...
	public final static double[] WINRATE_FILTER_FOR_SHOUYILV=new double[] {0.45,0.45,0.45,0.35,0.3};//{0.35,0.35,0.3,0.3,0.3};//{0.4,0.4,0.4,0.35,0.35};//{0.5,0.5,0.5,0.5,0.5};//{0,0,0,0,0};//{0.3,0.3,0.3,0.3,0.3};
	//对于胜率优先算法的收益率筛选阀值
