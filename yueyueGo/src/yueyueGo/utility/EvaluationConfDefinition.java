...
public class EvaluationConfDefinition implements Serializable{
	...
	public final static double[] WINRATE_FILTER_FOR_SHOUYILV=new double[] {0.35,0.35,0.3,0.3,0.3};//new double[] {0.45,0.45,0.45,0.35,0.3};//{0.4,0.4,0.4,0.35,0.35};//{0.5,0.5,0.5,0.5,0.5};//{0,0,0,0,0};//{0.3,0.3,0.3,0.3,0.3};
	//对于胜率优先算法的收益率筛选阀值
	//因为Adaboost不是很有效，这个阀值不太管用
	public final static double[] SHOUYILV_FILTER_FOR_WINRATE=new double[] {0.01,0.01,0.02,0.03,0.04};//{0.005,0.01,0.03,0.05,0.08};//{0.01,0.02,0.03,0.03,0.04};//{0.005,0.005,0.01,0.03,0.03};////{0,0,0,0,0};//{-100,-100,-100,-100,-100}; 
