...
implements AttributeTransformer, OptionHandler {
	...
	//TODO added by libo to use Normalized Filter @20170914
	private Normalize m_normalizeFilter;
	private boolean m_normalize=false;
	public void setNormalize(boolean needNormalization) {
		this.m_normalize = needNormalization;
	}
	...
	private void buildAttributeConstructor(Instances data) throws Exception {
		 ...
		 */
	    //TODO added by libo to normalize data before center it @20170914
	    if (m_normalize==true){
	...
	public Instance convertInstance(Instance instance) throws Exception {
		 ...
		 * }
		 */
	    //TODO added by libo to normalize data before center it  	@20170912
	    if (m_normalize==true){
	...
	//TODO added by libo to release memory after PCA
